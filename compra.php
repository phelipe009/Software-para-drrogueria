            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <form id="procesar-pago" action="#" method="post">
                        ...
                        <div class="form-group row">
                            <label for="dirección" class="col-12 col-md-2 col-form-label h2">Dirección :</label>
                            <div class="col-12 col-md-10">
                                <input type="text" class="form-control" id="lugar"
                                    placeholder="Ingresa la dirección de tu domicilio" name="direccion">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div id="carrito" class="form-group table-responsive" >
                            <table class="table" id="lista-compra" name="lista" >
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <input id="Producto" name="producto" class="font-weight-bold border-0" readonly style="background-color: white;"></input>
                                    </th>
                                    <!-- <th scope="col"></th> -->
                                </tr>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-2">
                                <a href="indexp.php" class="btn btn-info btn-block">Seguir comprando</a>
                            </div>
